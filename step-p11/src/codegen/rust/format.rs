...
///   - The input of rustfmt is completely generated by this crate, and thus it
///     must be a bug, i.e. not a runtime error.
pub fn rustfmt(tt: String) -> String {
    ...
    String::from_utf8(output.stdout)
        .expect("rustfmt output contains non-UTF8 input")
}
