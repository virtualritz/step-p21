...
/// This means
///
/// > knobs can only exist if they are used in the role of handle in one
/// > instance of a door
#[derive(Debug, Clone, PartialEq)]
pub struct InverseAttribute {
    ...
    /// Prefix of the attribute, used if the attribute is a sub-attribute of
    /// `dest` entity
