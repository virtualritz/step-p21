...
pub fn abstract_supertype_declaration(input: &str) -> ParseResult<'_, Constraint> {
...
pub fn subsuper(input: &str) -> ParseResult<'_, (Option<Constraint>, Option<SubTypeDecl>)> {
...
pub fn supertype_expression(input: &str) -> ParseResult<'_, SuperTypeExpression> {
    tuple((
        supertype_factor,
...
pub fn subtype_constraint_decl(input: &str) -> ParseResult<'_, SubTypeConstraint> {
    tuple((
