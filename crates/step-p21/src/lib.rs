//! step_p21 is a crate for reading and writing ASCII encoding of exchange
//! structure, a.k.a. STEP file, and for mapping them into Rust structs
//! generated by [step_p11](../step_p11/index.html) compiler.
//!
//! This crate also contains generated code as sub-modules for following
//! schemas:
//!
...
//!
//! They are compiled only when the `features` are enabled in cargo to keep
//! compile faster:
//!
//! ```toml
//! [dependencies]
...
//! This ISO document contains an example in section Annex H "Example of a
//! complete exchange structure":
//!
//! ```text
...
//! - `HEADER` section has three components `FILE_DESCRIPTION`, `FILE_NAME`, and
//!   `FILE_SCHEMA`.
...
//!     - Reference, e.g. `#1`
//! - Actual data, triangular geometry in this example, is stored in `DATA`
//!   section.
//!
...
// To work generated code by step_p21-derive only with step_p21
pub use derive_more;
pub use itertools;
pub use serde;

pub use step_p21_derive::*;
