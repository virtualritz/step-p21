...
- Recursive implementation of `step-p21::tables::EntityTable::{get_owned, owned_iter}` for select types. https://github.com/ricosjp/ruststep/pull/230
...
- Add `step-p21::ast::SubSuperRecord` https://github.com/ricosjp/ruststep/pull/225
- Document and tests for serde mapping in step-p21::ast::de https://github.com/ricosjp/ruststep/pull/220
- Document for step-p21::header https://github.com/ricosjp/ruststep/pull/218
- Design document of step-p21 crate https://github.com/ricosjp/ruststep/pull/214
- Term and definitions https://github.com/ricosjp/ruststep/pull/210
- Introduction to STEP, step-p11 design document https://github.com/ricosjp/ruststep/pull/208
...
### Changed
- `step-p21::ast::RValue` is renamed to `Name` https://github.com/ricosjp/ruststep/pull/219
- `step-p21::place_holder` is integrated into `step-p21::tables` https://github.com/ricosjp/ruststep/pull/216
...
### Added
- Re-expose serde and itertools from step-p21 https://github.com/ricosjp/ruststep/pull/199
...
- Implements `Serialize` to `step-p21::primitive::Logical`. https://github.com/ricosjp/ruststep/pull/170
...
- Expose the module `derive_more` in `step-p21`. https://github.com/ricosjp/ruststep/pull/144
- step_p11_derive crate, `step_p11_derive::inline_express!` macro https://github.com/ricosjp/ruststep/pull/158
- Expose `step_p21_derive::*` macros in `step-p21::` namespace https://github.com/ricosjp/ruststep/pull/159
...
- Remove `step_p21_derive::as_holder_visitor!` https://github.com/ricosjp/ruststep/pull/147
...
- Use `syn::Type` and other explicit types instead of `proc_macro2::TokenStream` in step-p11/codegen https://github.com/ricosjp/ruststep/pull/184
- Legalize the type declare of `SET` and `LIST`. https://github.com/ricosjp/ruststep/pull/171
- Snapshot testing for step-p21-derive https://github.com/ricosjp/ruststep/pull/175
- Refactoring `step-p11::codegen` https://github.com/ricosjp/ruststep/pull/165
- ignore pending snapshot https://github.com/ricosjp/ruststep/pull/164
- Snapshot testing for step-p11 https://github.com/ricosjp/ruststep/pull/163
- step-p21/tests uses `inline_express!` macro https://github.com/ricosjp/ruststep/pull/160
- Add flag to switch step-p21 internal/external codegen in IR::to_token_stream https://github.com/ricosjp/ruststep/pull/158
- Use rust-cache for faster CI https://github.com/ricosjp/ruststep/pull/156
- Comprehensive tests for step_p21_derive https://github.com/ricosjp/ruststep/pull/147
...
See https://github.com/ricosjp/ruststep/releases/tag/step-p21-0.1.0